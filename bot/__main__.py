...
from bot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, SUPPORT_CHAT, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
To add me to your group click ["HERE"](t.me/DAvinash97bot?startgroup=botstart)
You can find my list of available commands with /help.
[Ava's Repo](gitlab.com/DAvinash97/Ava) 
...
Ava is hosted on Heroku Servers and doesn't require any donations as of now but \
