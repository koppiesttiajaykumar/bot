...
from bot.modules.sql.global_bans_sql import is_user_gbanned
from bot import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, LOGGER
from bot.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text("Whoa! A member of the DevUser just joined!", reply_to_message_id=reply)

            # Welcome Sudos
            elif new_mem.id in SUDO_USERS:
                update.effective_message.reply_text("Huh! A Sudo Guy just joined! Stay Alert!", reply_to_message_id=reply)

            # Welcome yourself
            elif new_mem.id == bot.id:
                update.effective_message.reply_text("Look who's here 😎", reply_to_message_id=reply)
