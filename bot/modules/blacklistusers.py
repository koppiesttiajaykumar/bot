...
import bot.modules.sql.blacklistusers_sql as sql
from bot import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS
from bot.modules.helper_funcs.chat_status import dev_plus
from bot.modules.helper_funcs.extraction import extract_user_and_text, extract_user
from bot.modules.log_channel import gloggable

#BLACKLISTWHITELIST = [OWNER_ID] + DEV_USERS + SUDO_USERS
