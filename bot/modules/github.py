# Module from corsicanu bot linked here:- https://github.com/corsicanu/tgbot/blob/mybot/tg_bot/modules/github.py
# All Credits goes to NunoPenim@github for this module
import html
...
from bot import dispatcher, OWNER_ID, LOGGER, SUDO_USERS
