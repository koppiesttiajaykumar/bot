...
from bot import dispatcher, DEL_CMDS, SUDO_USERS, DEV_USERS
...
def sudo_plus(func):
    ...
    def is_sudo_plus_func(bot: Bot, update: Update, *args, **kwargs):
        ...
        if user and is_sudo_plus(chat, user.id):
            ...
            update.effective_message.reply_text("Who dis non-admin telling me what to do? You want a ban?")
...
from bot.modules import connection
