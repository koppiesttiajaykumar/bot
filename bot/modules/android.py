# Module from corsicanu bot linked here:- https://github.com/corsicanu/tgbot/blob/mybot/tg_bot/modules/android.py
# All Credits goes to Corsicanu@github for this module
import re, html, time
