...
from bot import dispatcher, TOKEN, SUDO_USERS
from bot.modules.disable import DisableAbleCommandHandler
from bot.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin, connection_status
...
def invite(bot: Bot, update: Update):
    ...
    if chat.username:
        update.effective_message.reply_text("https://t.me/{}".format(chat.username))
