...
from bot import dispatcher, LOGGER, DEV_USERS, SUDO_USERS, BAN_STICKER, UNBAN_STICKER
from bot.modules.disable import DisableAbleCommandHandler
from bot.modules.helper_funcs.chat_status import (bot_admin, user_admin, is_user_ban_protected, can_restrict,
...
from bot.modules.log_channel import loggable, gloggable
...
SELFUNBAN_HANDLER = CommandHandler("selfunban", selfunban, pass_args=True)
...
__mod_name__ = "Bans"
__handlers__ = [BAN_HANDLER, TEMPBAN_HANDLER, KICK_HANDLER, UNBAN_HANDLER, SELFUNBAN_HANDLER, KICKME_HANDLER]
